...
* **AI Agent & LLM:** LangChain Agent powered by **Google Gemini 3.1 Flash Lite**.
...
2. **Media Download & OCR Processing:** Images are downloaded securely, processed via Tesseract OCR, and evaluated for confidence level. If confidence is insufficient (< 65%), the image is escalated to Gemini Vision.
...
1. Clone this repository:
   ```bash
   git clone [https://github.com/Niquitof/pharmacie-ai-agent.git](https://github.com/Niquitof/pharmacie-ai-agent.git)